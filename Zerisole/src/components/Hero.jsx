      ...
      <div className="container mx-auto px-6 relative z-10 mt-0 sm:-mt-22">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-7xl lg:text-[84px] font-black text-[#0F172A] dark:text-white leading-[1.1] tracking-tight mb-8"
          >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-[#4F46E5] text-white font-bold rounded-full hover:bg-[#4338CA] transition-all shadow-xl shadow-indigo-500/20 text-[16px] w-full sm:w-[230px] whitespace-nowrap"
            >
              Free Consultation
