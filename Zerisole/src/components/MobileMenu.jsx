                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 flex items-center justify-center">
                                    <svg viewBox="0 0 100 100" className="w-full h-full">
                                        <path d="M25 25H75L25 75H75" stroke="#10b981" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                                    </svg>
                                </div>
                                <span className="text-xl font-bold dark:text-white tracking-tighter">ZERISOL</span>
                            </div>
                            <button
                                onClick={onClose}
